            ...
            <div class="section">
                <form @submit.prevent method="post">
                    ...
                    <div class="sc check" :style="{ borderColor: telBot ? '#000' : '' }">
                        <i class="phone"></i>
                        <input type="hidden" name="type"/>
                        <input v-model="checkNum" type="text" placeholder="请输入图形验证码"/>
                        <b @click="getNewNum">{{ osg }}</b>
                    </div>
                    <div class="sc check" :style="{ borderColor: telBot ? '#000' : '' }">
                        <i class="phone"></i>
                        <input type="hidden" name="type"/>
                        <input v-model="telNum" type="text" placeholder="请输入手机验证码"/>
                    ...
                    <button :style="{ backgroundColor: canRegister ? '#1bbc9b' : '' }" @click="register">
                        立即注册
                    </button>
                </form>
            </div>
